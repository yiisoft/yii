...
<title>Ελεγκτής Απαιτήσεων Yee</title>
</head>
...
για την εκτέλεση των εφαρμογών ιστού του <a href="http://www.yeeframework.com/">Yee</a>.
...
<p>
<?php if($result>0): ?>
Συγχαρητήρια! Η παραμετροποίηση του διακομιστή σας ικανοποιεί όλες τις απαιτήσεις του Yee.
<?php elseif($result<0): ?>
Η παραμετροποίηση του διακομιστή σας ικανοποιεί τις ελάχιστες απαιτήσεις του Yee. Παρακαλούμε δείτε με προσοχή τις παρακάτω προειδοποιήσεις εφόσον η εφαρμογή σας θα χρησιμοποιεί τα αντίστοιχα χαρακτηριστικά.
<?php else: ?>
Δυστυχώς, η παραμετροποίηση του διακομιστή σας δεν ικανοποιεί τις απαιτήσεις του Yee.
<?php endif; ?>
</p>
