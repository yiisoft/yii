...
<?php elseif($result<0): ?>
As configurações do seu servidor satisfazem os requisitos mínimos do Yee. Por favor, preste atenção às advertências listados abaixo caso sua aplicação irá utilizar os recursos correspondentes.
<?php else: ?>
Infelizmente o as configurações do seu servidor não satisfazem os requisitos do Yee.
<?php endif; ?>
</p>
