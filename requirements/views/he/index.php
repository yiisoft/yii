...
<title>בדיקת דרישות מינימום להרצת Yee</title>
</head>
...
<div id="header">
<h1>בדיקת דרישות מינימום להרצת Yee</h1>
</div><!-- header-->
...
הסקריפט הבא בודק אם סביבת השרת שלך תוכל לעמוד בדרישות המינימום כדי להריץ את 
 <a href="http://www.yeeframework.com/">Yee</a> לפיתוח מערכות ווב מתקדמות.
...
<p>
<?php if($result>0): ?>
ברכותיינו! סביבת השרת שלך תומכת בכל הגדרישות של Yee.
<?php elseif($result<0): ?>
הגדרות סביבת השרת שלך מתאימות לדרישות המינימום של Yee.
 אנא שים לב לאזהרות והערות הכתובות מטה במידה והאפליקציה שתכתוב תשתמש באחת מהאפשרויות הללו.
<?php else: ?>
לצערנו סביבת השרת שלך אינה תומכת בדרישות המינימום של Yee.
<?php endif; ?>
</p>
