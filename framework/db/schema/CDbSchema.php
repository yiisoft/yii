...
abstract class CDbSchema extends CComponent
{
	 ...
	 * physical types):
	 * <ul>
	 * <li>pk and bigpk: an auto-incremental primary key type, will be converted into "int NOT NULL AUTO_INCREMENT PRIMARY KEY" or "bigint(20) NOT NULL AUTO_INCREMENT PRIMARY KEY"</li>
	 * <li>string: string type, will be converted into "varchar(255)"</li>
	 * <li>text: a long string type, will be converted into "text"</li>
	 * <li>integer: integer type, will be converted into "int"</li>
	 * <li>bigint: integer type, will be converted into "bigint"</li>
	 * <li>boolean: boolean type, will be converted into "tinyint"</li>
