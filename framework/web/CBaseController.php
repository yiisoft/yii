...
abstract class CBaseController extends CComponent
{
	 ...
	 * @return string|false the file path for the named view. False if the view cannot be found.
	 */
	 ...
	 * @param bool $return whether the rendering result should be returned instead of being echoed
	 ...
	 * @param bool $captureOutput whether to capture the output of the widget. If true, the method will capture
	 ...
	 * @return \CWidget|string the widget instance when $captureOutput is false, or the widget output when $captureOutput is true.
	 ...
	 * @return bool whether we need to generate content for caching. False if cached version is available.
	 * @see endCache
	 */
