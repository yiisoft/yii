...
class ModelCode extends CCodeModel
{
	 ...
	 * @return bool true if table matches description of helper table.
	 */
	...
	{
		if(Yii::app()->hasComponent($this->connectionId)===false || !(Yii::app()->getDb($this->connectionId) instanceof CDbConnection))
