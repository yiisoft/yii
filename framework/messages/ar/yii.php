...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute عثر على الكتلة البرمجية "{token}" الغير مطابقة. تأكد من أن النداءات إلى Yee::beginProfile() و Yee::endProfile() متداخلة بشكل صحيح.',
  ...
  'Powered by {yee}.' => 'مشغل بواسطة {yee}.',
  ...
  'Yes' => 'نعم',
  'Yee application can only be created once.' => 'تطبيق Yee يمكن إنشاؤه مرة واحدة فقط.',
