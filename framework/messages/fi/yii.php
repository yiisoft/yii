...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute löysi yhteensopimattoman koodilohkon "{token}". Varmista, että Yee::beginProfile() ja Yee::endProfile() -kutsut on sisennetty oikein.',
  ...
  'Yes' => 'Kyllä',
  'Yee application can only be created once.' => 'Yee-sovellus voidaan luoda vain kerran.',
