...
return array (
  ...
  'The "forceCopy" and "linkAssets" cannot be both true.' => '"forceCopy" ja "linkAssets" eivät molemmat voi olla tosia.',
  'The $converter argument must be a valid callback or null.' => '$converter argumentin täytyy olla kelvollinen callback tai null.',
  'Yes' => 'Kyllä',
  '{class} requires the Blowfish option of the PHP crypt() function. This system does not have it.' => '{class} vaatii Blowfish-option PHP:n crypt()-funktiolle. Tästä järjestelmästä se puuttuu.',
  '{class} requires the PHP crypt() function. This system does not have it.' => '{class} vaatii PHP:n crypt()-funktion. Tästä järjestelmästä se puuttuu.',
  '{class}::$cost must be a number.' => '{class}::$cost täytyy olla luku.',
  '{class}::$cost must be between 4 and 31.' => '{class}::$cost täytyy olla väliltä 4 ja 31.',
