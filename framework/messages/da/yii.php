...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute fandt en mismatchende kodeblock "{token}". Tjek at kaldene til Yee::beginProfile() og Yee::endProfile() er korrekt indlejret.',
  ...
  'Yes' => 'Ja',
  'Yee application can only be created once.' => 'Yee-applikationen kan kun oprettes en gang.',
