...
return array (
  ...
  'The "filter" property must be specified with a valid callback.' => '"filter" egenskaben skal være specifiseret med et gyldigt "callback".',
  'The "forceCopy" and "linkAssets" cannot be both true.' => '"forceCopy" og "linkAssets" kan ikke begge være true.',
  'The "pattern" property must be specified with a valid regular expression.' => '"pattern" egenskaben skal være specifiseret med en gyldig regular expression',
  'The "range" property must be specified with a list of values.' => '"range" skal være specifiseret med en liste af værdier.',
  ...
  'The relation "{relation}" in active record class "{class}" is not specified correctly: the join table "{joinTable}" given in the foreign key cannot be found in the database.' => 'Relationen "{relation}" i Active Record klassen "{class}" er ikke specifiseret korrekt: Join tabellen  "{joinTable}" givet i primary key findes ikke i databasen',
  'The relation "{relation}" in active record class "{class}" is specified with a foreign key "{key}" that does not point to the parent table "{table}".' => 'Relationen "{relation}" i Active Record klassen "{class}" er specifiseret med en primary key som ikke peger på parent tabellen "{table}".',
  'The relation "{relation}" in active record class "{class}" is specified with an incomplete foreign key. The foreign key must consist of columns referencing both joining tables.' => 'Relationen "{relation}" i Active Record klassen "{class}" er specifiseret med en ufuldstændig primary key. Primary key skal bestå af kolonner som refererer til begge tabeller som bliver joinet.',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". There is no such column in the table "{table}".' => 'Relationen "{relation}" i Active Record klassen "{class}" er specifiseret med en ugyldig primary key "{key}". Det er ingen sådan kolonne i tabellen "{table}".',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key. The columns in the key must match the primary keys of the table "{table}".' => 'Relationen "{relation}" i Active Record klassen "{class}" er specifiseret med en ugyldig primary key. Kolonnerne i nøglen skal matche primary keys i tabellen "{table}".',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key. The format of the foreign key must be "joinTable(fk1,fk2,...)".' => 'Relationen "{relation}" i Active Record klassen "{class}" er specifiseret med en ugyldig primary key. Formatet for primary key skal være "joinTable(fk1,fk2,...)".',
  ...
  '{class} has an invalid validation rule. The rule must specify attributes to be validated and the validator name.' => '{class} har en ugyldig valideringsregel. Reglen skal specifisere attributer som skal valideres samt navnet på validatoren.',
  '{class} must specify "model" and "attribute" or "name" property values.' => '{class} skal specifisere egenskaberne "model" og "attribute" eller "name".',
