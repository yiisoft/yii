...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute natrafił na błędny blok kodu "{token}". Upewnij się, że wywołania Yee::beginProfile() i Yee::endProfile() są poprawnie zagnieżdżone.',
  ...
  'Yee application can only be created once.' => 'Aplikacja Yee może być utworzona tyko raz.',
