...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute je našao neusaglašen blok koda "{token}". Budite sigurni da su pozivi Yee::beginProfile() i Yee::endProfile() ispravno ugnježdeni.',
  ...
  'Yee application can only be created once.' => 'Yee aplikacija može biti kreirana samo jedanput.',
