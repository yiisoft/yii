...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'Компонент CProfileLogRoute обнаружил неверный код "{token}". Удостоверьтесь, что вложенность вызовов Yee::beginProfile() и Yee::endProfile() соблюдается.',
  ...
  'Yes' => 'Да',
  'Yee application can only be created once.' => 'Приложение Yee может быть создано только один раз.',
