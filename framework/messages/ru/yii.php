...
return array (
  ...
  '{class} does not have attribute "{attribute}".' => 'Класс {class} не содержит атрибута "{attribute}".',
  ...
  '{class} does not have attribute "{name}".' => 'Класс {class} не имеет атрибута "{name}".',
