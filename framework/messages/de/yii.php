...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute fand einen unzugehörigen Code-Block "{token}". Stellen Sie sicher dass Aufrufe von Yee::beginProfile() und Yee::endProfile() richtig verschachtelt sind.',
  ...
  'Yes' => 'Ja',
  'Yee application can only be created once.' => 'Eine Yee Applikation kann nur einmal erzeugt werden.',
