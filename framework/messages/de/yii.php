...
return array (
  '&lt; Previous' => '&lt; Vorherige',
  '&lt;&lt; First' => '&lt;&lt; Erste',
  'CHttpRequest is unable to determine the path info of the request.' => 'CHttpRequest kann die Pfadinformationen der Anfrage nicht bestimmen.',
  'CHttpRequest is unable to determine the request URI.' => 'CHttpRequest kann die Anfrage-URI nicht bestimmen.',
  'CXCache requires PHP XCache extension to be loaded.' => 'CXCache erfordert, dass die XCache Extension geladen wurde.',
  'Cannot add "{name}" as a child of itself.' => 'Kann "{name}" nicht als Kind von sich selbst hinzufügen.',
  'Go to page: ' => 'Zu Seite:',
  'Last &gt;&gt;' => 'Letzte &gt;&gt;',
  'Next &gt;' => 'Nächste &gt;',
  'The column "{column}" is not a foreign key in table "{table}".' => 'Die Spalte "{column}" ist kein Fremdschlüssel in Tabelle "{table}".',
  ...
  '{class} does not support fetching all table names.' => '{class} unterstützt das Lesen aller Tabellennamen nicht.',
