...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute је нашао неусаглашен блок кода "{token}". Будите сигурни да су позиви Yee::beginProfile() и Yee::endProfile() исправно угњеждени.',
  ...
  'Yee application can only be created once.' => 'Yee апликација може бити креирана само једанпут.',
