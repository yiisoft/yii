...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute konstatēja nekorektu koda bloku "{token}". Pārliecinieties, ka ir atbilstoši Yee::beginProfile() un Yee::endProfile() izsaukumi.',
  ...
  'Yee application can only be created once.' => 'Yee lietojumprogramma var tikt inicializēta tikai vienu reizi.',
