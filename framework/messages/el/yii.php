...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'Το CProfileLogRoute βρήκε ένα τμήμα κώδικα "{token}" που δεν ταιριάζει. Επιβεβαιώστε ότι οι κλήσεις στο Yee::beginProfile() και Yee::endProfile() είναι σωστά φωλιασμένες.',
  ...
  'Powered by {yee}.' => 'Ο ιστοτόπος τρέχει {yee}.',
  ...
  'Yee application can only be created once.' => 'Η εφαρμογή Yee μπορεί να δημιουργηθεί μία μόνο φορά.',
