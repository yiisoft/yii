...
return array (
  ...
  'The file "{file}" cannot be uploaded. It contains malicious code.' => 'Не вдалося завантажити файл "{file}". Він містить зловмисний код.',
  'The file "{file}" cannot be uploaded. Only files with these extensions are allowed: {extensions}.' => 'Не вдалося завантажити файл "{file}". Дозволено завантаження файлів тільки із наступними розширеннями: {extensions}.',
