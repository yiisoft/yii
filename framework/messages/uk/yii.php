...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'Компонент CProfileLogRoute виявив невірний код "{token}". Переконайтесь, що вкладеність викликів Yee::beginProfile() та Yee::endProfile() дотримується.',
  ...
  'Yee application can only be created once.' => 'Додаток Yee може бути створено тільки один раз.',
