...
return array (
  ...
  'Active record "{class}" has an invalid configuration for relation "{relation}". It must specify the relation type, the related active record class and the foreign key.' => 'Конфігурація active record "{class}" невірна для бінарних відношень (реляцій) "{relation}". Мусить визначатись тип відношення, active record класу відношення та зовнішнього ключа.',
  ...
  'Get a new code' => 'Взяти новий код',
  ...
  '{class} does not have relation "{name}".' => '{class} не має відношення з назвою "{name}".',
