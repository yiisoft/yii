...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute מצא בלוק אשר לא תואם בשרשור שלו "{token}". אנא וודא שקריאות ל Yee::beginProfile() ו Yee::endProfile() משורשרות בהתאם.',
  ...
  'Yee application can only be created once.' => 'ניתן ליצור אפליקציה רק פעם אחת.',
