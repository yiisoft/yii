...
return array (
  'Yii application can only be created once.' => 
  		'Solo se puede crear una aplicación Yii.',
  'Alias "{alias}" is invalid. Make sure it points to an existing directory or file.' => 
  		'Alias "{alias}" es inválido. Verifique que el mismo apunta a un directorio o archivo exisitente.',
  'Path alias "{alias}" is redefined.' => 
  		'Ruta de alias "{alias}" ya se encuentra definida.',
  'Path alias "{alias}" points to an invalid directory "{path}".' =>
		'Ruta de alias "{alias}" apunta a un directorio inválido "{path}".',
  'Application base path "{path}" is not a valid directory.' => 
  		'Ruta base de la aplicación "{path}" no es un directorio válido.',
  'Application runtime path "{path}" is not valid. Please make sure it is a directory writable by the Web server process.' => 
  		'Ruta de runtime de aplicación "{path}" es inválida. Verifique que sea un directorio con permisos de escritura por el proceso que corre el servidor Web.',
  'Property "{class}.{property}" is not defined.' => 
  		'Propiedad "{class}"."{property}" no se encuentra definida.',
  'Property "{class}.{property}" is read only.' => 
  		'Propiedad "{class}"."{property}" es de solo lectura..',
  'Event "{class}.{event}" is not defined.' => 
  		'Evento "{class}"."{event}" no se encuentra definido.',
  'Event "{class}.{event}" is attached with an invalid handler "{handler}".' => 
  		'Evento "{class}"."{event}" tiene asociado un manejador "{handler}" inválido.',
  'Invalid enumerable value "{value}". Please make sure it is among ({enum}).' => 
  		'Valor de enumerador inválido "{value}". Asegurese que este entre ({enum}).',
  '{class} has an invalid validation rule. The rule must specify attributes to be validated and the validator name.' => 
  		'{class} tiene una regla de validación inválida. La regla se debe especificar attributos para ser validados y el nombre de su validador.',
  ...
  'CSecurityManager.validation must be either "MD5" or "SHA1".' => 
  		'CSecurityManager.validation debe ser "MD5" ó "SHA1".',
  'CSecurityManager requires PHP mcrypt extension to be loaded in order to use data encryption feature.' => 
  		'CSecurityManager requiere que la extensión mcrypt de PHP sea cargada para utilizar la opción de encriptación de datos.',
  'Unable to create application state file "{file}". Make sure the directory containing the file exists and is writable by the Web server process.' => 
  		'No se ha podido crear el archivo de estado de aplicación "{file}". Asegurese que el directorio que contiene el archivo exista y sea un directorio con permisos de escritura por el proceso que corre el servidor Web.',
  'CApcCache requires PHP apc extension to be loaded.' => 
  		'CApcCache requiere que la extensión apc de PHP se encuentre cargada.',
  ...
  'CDbCache.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 
  		'CDbCache.connectionID "{id}" es inválido. Asegurese que refiera a un ID de un componente de aplicación CDbConnection.',
  'CMemCache requires PHP memcache extension to be loaded.' => 
  		'CMemCache requiere que la extensión memcache de PHP se encuentre cargada.',
  'CMemCache server configuration must have "host" value.' => 
  		'La configuración del servidor CMemCache debe contener un "host".',
  'CMemCache server configuration must be an array.' => 
  		'La configuración del servidor CMemCache debe ser un array.',
  'CDbCacheDependency.sql cannot be empty.' => 
  		'CDbCacheDependency.sql no puede ser vacío.',
  'CDbHttpSession.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 
  		'CDbHttpSession.connectionID "{id}" es inválido. Asegurese que refiera a un ID de un componente de aplicación CDbConnection',
  'CDirectoryCacheDependency.directory cannot be empty.' => 
  		'CDirectoryCacheDependency.directory no puede ser vacío.',
  ...
  'Error: Table "{table}" has a composite primary key which is not supported by crud command.' => 
  		'Error: Tabla "{table}" tiene una clave primaria compuesta que no es soportada por el comando crud.',
  'Object configuration must be an array containing a "class" element.' =>
		'La configuración del objeto debe ser un array conteniendo un elemento "class".',
  ...
  'The map is read only.' => 
  		'El mapa es de solo lectura',
  'Map data must be an array or an object implementing Traversable.' => 
  		'Los datos del mapa deben ser un array o un objeto que implemento Traversable',
  'Queue data must be an array or an object implementing Traversable.' => 
  		'Los datos de la cola deben ser un array o un objeto que implemento Traversable',
  ...
  'CDbConnection is inactive and cannot perform any DB operations.' => 
  		'CDbConnection se encuentra inactiva y no puede realizar operaciones de BD.',
  'CDbConnection does not support reading schema for {driver} database.' => 
  		'CDbConnection no soporta la lectura del esquema para la base de datos {driver}.',
  'CDbDataReader cannot rewind. It is a forward-only reader.' => 
  	'CDbDataReader no puede volver atras ya que es un lector de un avance únicamente.',
  'CDbTransaction is inactive and cannot perform commit or roll back operations.' => 
  		'CDbTransaction se encuentra inactiva y no puede realizar la operación commit ni roll back.',
  'Relation "{name}" is not defined in active record class "{class}".' => 
  		'La relación "{name}" no se encuentra definida en la clase active record "{class}".',
  'Active record "{class}" is trying to select an invalid column "{column}". Note, the column must exist in the table or be an expression with alias.' => 
  		'Active record "{class}" esta intentando de seleccionar una columna inválida "{column}". Nota: La columna puede existir en la base o ser una expresion con alias.',
  'The relation "{relation}" in active record class "{class}" is not specified correctly: the join table "{joinTable}" given in the foreign key cannot be found in the database.' => 
  		'La relación "{relation}" en la clase active record "{class}" no se encuentra especificada correctamente: La tabla de junta (join table) "{join table}" dada no se encontro en la base de datos.',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". The foreign key does not point to either joining table.' => 
  		'La relación "{relation}" en la clase active record "{class}" se encuentra especificada con una clave foranea inválida "{key}". La clave foranea no apunta a la tabla de junta (joining table).',
  'The relation "{relation}" in active record class "{class}" is specified with an incomplete foreign key. The foreign key must consist of columns referencing both joining tables.' => 
  		'La relación "{relation}" en la clase active record "{class}" se encuentra especificada con una clave foranea incompleta. La clave foranea debe consistir de las columnas que referencian la junta de tablas.',
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key. The format of the foreign key must be "joinTable(fk1,fk2,...)".' => 
  		'La relación "{relation}" en la clase active record "{class}" se encuentra especificada con una clave foranea inválida. El formato de la clave foranea debe ser "joinTable(fk1,fk2,...)".',
  'Active Record requires a "db" CDbConnection application component.' => 
  		'Active Record requiere un componente de aplicación "db" del tipo CDbConnection.',
  ...
  'The table "{table}" for active record class "{class}" cannot be found in the database.' => 
  		'La tabla "{table}" definida en la clase active record "{class}" no se ha podido encontrar en la base de datos.',
  'Active record "{class}" has an invalid configuration for relation "{relation}". It must specify the relation type, the related active record class and the foreign key.' => 
  		'Active record "{class}" contiene una configuración de relación inválida "{relation}". La misma debe especificar el tipo de relación, la clase active record relacionada y la clave foranea.',
  ...
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => 
  			'El valor de la clave primaria "{key}" no ha sido otorgado cuando se consulto la tabla "{table}".',
  ...
  'CDbMessageSource.connectionID is invalid. Please make sure "{id}" refers to a valid database application component.' => 
  		'CDbMessageSource.connectionID es inválido. Asegurese que "{id}" refiera a un componente de aplicación de base de datos válido.',
  ...
  'CDbLogRoute requires database table "{table}" to store log messages.' => 
  		'CDbLogRoute requiere la tabla "{table}" de la base de datos para guardar los mensajes de log.',
  'CDbLogRoute.connectionID "{id}" does not point to a valid CDbConnection application component.' => 
  		'CDbLogRoute.connectionID "{id}" no refiere a un componente de aplicación CDbConnection válido.',
  'CFileLogRoute.logPath "{path}" does not point to a valid directory. Make sure the directory exists and is writable by the Web server process.' => 
  		'CFileLogRoute.logPath "{path}" no apunta a un directorio válido. Verifique que el directorio exista y tenga permisos de escritura por el proceso que corre el servidor Web.',
  'Log route configuration must have a "class" value.' => 
  		'La configuración de la ruta de log debe contener un valor de "class".',
  'CProfileLogRoute.report "{report}" is invalid. Valid values include "summary" and "callstack".' => 
  		'CProfileLogRoute.report "{report}" es inválido. Los valores validos son "summary" y "callstack".',
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yii::beginProfile() and Yii::endProfile() be properly nested.' => 
  		'CProfileLogRoute ha encontrado un bloque de código "{token}" desalineado. Asegurese que las llamadas a Yii::beginProfile() y a Yii::endProfile() esten correctamente anidadas.',
  'CCaptchaValidator.action "{id}" is invalid. Unable to find such an action in the current controller.' => 
  		'CCaptchaValidator.action "{id}" es inválido. No se há podido encontrar dicha acción en el controlador actual.',
  ...
  'CAssetManager.basePath "{path}" is invalid. Please make sure the directory exists and is writable by the Web server process.' => 
  		'CAssetManager.basePath "{path}" es inválido. Verifique que el directorio exista y tenga permisos de escritura por el proceso que corre el servidor Web.',
  'The asset "{asset}" to be pulished does not exist.' => 
  		'El asset "{asset} a ser publicado no existe.',
  '{controller} contains improperly nested widget tags in its view "{view}". A {widget} widget does not have an endWidget() call.' => 
  		'{controller} contiene etiquetas de widget en la vista "{view}" anidados incorrectamente. {widget} widget no contiene la llamada a endWidget().',
  '{controller} has an extra endWidget({id}) call in its view.' => 
  		'{controller} tiene una llamada extra a endWidget({id}) en su vista.',
  'CCacheHttpSession.cacheID is invalid. Please make sure "{id}" refers to a valid cache application component.' => 
  		'CCacheHttpSession.cacheID es inválido. Asegurese que "{id}" refiere a un componente de aplicación de cache válido.',
  'The system is unable to find the requested action "{action}".' => 
  		'El sistema no ha podido encontrar la acción "{action}" solicitada.',
  ...
  'CDbAuthManager.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 
  		'CDbAuthManager.connectionID "{id}" es inválido. Asegurese que se refiere a un ID de un componente de aplicación CDbConnection.',
  ...
  'Filter "{filter}" is invalid. Controller "{class}" does have the filter method "filter{filter}".' => 
  		'El filtro "{filter} es inválido. El controlador "{class}" no contiene el método de filtro "filter{filter}".',
  ...
  'This content requires the <a href="http://www.adobe.com/go/getflash/">Adobe Flash Player</a>.' => 
  		'Este contenido requiere el <a href="http://www.adobe.com/go/getflash/">Adobe Flash Player</a>.',
  '{class} must specify "model" and "attribute" or "name" property values.' => 
  		'{class} debe especificar los valores de propiedad "model" y "attribute" o "name".',
  'CMultiFileUpload.name is required.' => 
  		'CMultiFileUpload.name es requerido',
  'Unable to replay the action "{object}.{method}". The method does not exist.' => 
  		'Imposible de replicar la acción "{object}.{method}". El metodo es inexistente.',
  '{widget} cannot find the view "{view}".' => 
  		'{widget} no ha podido encontrar la vista "{view}".',
