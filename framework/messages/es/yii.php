...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute ha encontrado un bloque de código "{token}" no coincidente. Asegúrese que las llamadas a Yee::beginProfile() y a Yee::endProfile() esten correctamente anidadas.',
  ...
  'Powered by {yee}.' => 'Potenciado por {yee}.',
  ...
  'Yes' => 'Si',
  'Yee application can only be created once.' => 'La aplicación Yee puede ser creada solo una vez.',
