...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute が整合の取れないコードブロック "{token}" を見つけました。Yee::beginProfile() と Yee::endProfile()の呼び出しが正しくネストされているか確認してください。',
  ...
  'Yes' => 'はい',
  'Yee application can only be created once.' => 'Yeeアプリケーションは一度しか作成できません。',
