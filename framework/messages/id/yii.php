...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute menemukan blok kode tidak sama "{token}". Pastikan panggilan Yee::beginProfile() dan Yee::endProfile() di-nested dengan benar.',
  ...
  'Yee application can only be created once.' => 'Aplikasi Yee hanya bisa dibuat satu kali.',
