...
return array (
  ...
  '{attribute} is too big (maximum is {max}).' => '{attribute} е прекалено голям (максимума е {max})',
  ...
  '{attribute} is too small (minimum is {min}).' => ' {attribute} e прекалено малак (минимума е {min}). ',
