...
return array (
  'Powered by {yee}.' => 'Задвижван от {yee}.',
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute намери несъответстващ блок от код "{token}". Моля, проверете дали обръщането към Yee::beginProfile() и Yee::endProfile() е вложено правилно.',
  ...
  'Yee application can only be created once.' => 'Yee приложението може да бъде стартирано само веднъж',
