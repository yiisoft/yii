...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute พบคำสั่งที่ห้ามใช้งาน "{token}". กรุณาตรวจสอบว่าการเรียกใช้งาน Yee::beginProfile() และ Yee::endProfile() จะต้องถูกระบุคุณสมบัติต่างๆที่ถูกต้อง',
  ...
  'Yee application can only be created once.' => 'โปรแกรม Yee สามารถสร้างได้เพียงครั้งเดียวเท่านั้น',
