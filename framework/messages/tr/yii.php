...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute eşleşmeyen bir kod bloğu buldu "{token}". Yee::beginProfile() ve Yee::endProfile() methodlarına yapılan call isteklerinin düzgün bir şekilde sıralandığına (nested) emin olun. ',
  ...
  'Yee application can only be created once.' => 'Yee uygulaması yanlızca bir kez oluşturulabilir.',
