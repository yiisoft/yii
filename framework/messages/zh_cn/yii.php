...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute found a mismatching code block "{token}". 请确定对于 Yee::beginProfile() 与 Yee::endProfile() 的呼叫是适当地巢状套叠的.',
  ...
  'Yee application can only be created once.' => 'Yee 应用程序只能被产生一次.',
