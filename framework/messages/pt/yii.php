...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute encontrou uma combinação errada no bloco de código "{token}". Tente chamar Yee::beginProfile() e Yee::endProfile() para ser apropriadamente aninhado.',
  ...
  'Yee application can only be created once.' => 'A aplicação Yee só pode ser criada uma vez.',
