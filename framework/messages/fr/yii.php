...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute a trouvé un bloc de code « {token} » incorrect. Vérifiez que les appels à Yee::beginProfile() et à Yee::endProfile() sont correctement imbriqués.',
  ...
  'Yee application can only be created once.' => 'Une seule application Yee peut être créée.',
