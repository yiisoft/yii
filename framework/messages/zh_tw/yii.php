...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute found a mismatching code block "{token}". 請確定對於 Yee::beginProfile() 與 Yee::endProfile() 的呼叫是適當地巢狀套疊的.',
  ...
  'Yee application can only be created once.' => 'Yee 應用程式只能被產生一次.',
