...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute zjistil nesprávně uspořádané bloky kódu "{token}". Ujistěte se, že volání Yee::beginProfile() a Yee::endProfile() jsou vložené správně.',
  ...
  'Yee application can only be created once.' => 'Yee aplikace může být vytvořená pouze jednou.',
