...
return array (
  ...
  'Log route configuration must have a "class" value.' => '@@La configurazione del percorso di log deve specificare un valore "class".@@',
  'Path alias "{alias}" is redefined.' => '@@Il percorso dell\'alias "{alias}" è già definito.@@',
  'Path alias "{alias}" points to an invalid directory "{path}".' => '@@Il percorso dell\'alias "{alias}" punta ad una cartella non valida "{path}".@@',
  ...
  'Property "{class}.{property}" is not defined.' => 'La propietà "{class}"."{property}" non è definita.',
  'Property "{class}.{property}" is read only.' => 'La propietà "{class}"."{property}" è di sola lettura.',
  ...
  'The "view" property is required.' => 'La propietà "view" è richiesta.',
