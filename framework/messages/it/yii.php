 ...
 */
return array (
  'CHttpRequest is unable to determine the path info of the request.' => 'CHttpRequest non può determinare le informazioni sul percorso della richiesta.',
  'CHttpRequest is unable to determine the request URI.' => 'CHttpRequest non può determinare l\'URI richiesto.',
  'CXCache requires PHP XCache extension to be loaded.' => 'CXCache richiede che l\'estensione PHP XCache sia caricata.',
  ...
  '{class} does not support fetching all table names.' => '{class} non può ottenere i nomi di tutte le tabelle.',
