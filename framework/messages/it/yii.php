...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute ha trovato un blocco di codice "{token}" disallineato. Verificare che le chiamate a Yee::beginProfile() e a Yee::endProfile() siano correttamente annidate.',
  ...
  'Yee application can only be created once.' => 'Si può creare una sola applicazione Yee.',
