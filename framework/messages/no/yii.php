...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute fant en mismatchende kodeblock "{token}". Sjekk at kallene til  Yee::beginProfile() og Yee::endProfile() er riktig nøstet.',
  ...
  'Yee application can only be created once.' => 'Yee-applikasjonen kan bare opprettes en gang.',
