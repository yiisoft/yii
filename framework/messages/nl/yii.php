...
return array (
  ...
  'Application base path "{path}" is not a valid directory.' => 'Applicatie base path "{path}" is geen geldige directory.',
  ...
  'CApcCache requires PHP apc extension to be loaded.' => 'CApcCache vereist de PHP APC extensie om te worden geladen.',
  ...
  'CDbCacheDependency.sql cannot be empty.' => 'CDbCacheDependency.sql kan niet leeg zijn.',
  'CDbCommand failed to execute the SQL statement: {error}' => 'CDbCommand heeft het SQL statement niet kunnen uitvoeren: {error}',
  'CDbCommand failed to prepare the SQL statement: {error}' => 'CDbCommand heeft het SQL statement niet kunnen voorbereiden: {error}',
  'CDbConnection does not support reading schema for {driver} database.' => 'CDbConnection biedt geen ondersteuning voor het lezen van schema voor {driver} database.',
  'CDbConnection failed to open the DB connection: {error}' => 'CDbConnection heeft de DB connectie niet kunnen openen: {error}',
  'CDbConnection is inactive and cannot perform any DB operations.' => 'CDbConnection is niet inactief en kan geen DB commando\'s uitvoeren.',
  'CDbConnection.connectionString cannot be empty.' => 'CDbConnection.connectionString kan niet leeg zijn',
  'CDbDataReader cannot rewind. It is a forward-only reader.' => 'CDbDataReader kan niet terugspoelen. Het is een forward-only lezer.',
  'CDbHttpSession.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => '',
  'CDbLogRoute requires database table "{table}" to store log messages.' => 'CDbLogRoute vereist database tabel "(table)" om het logberichten op te kunnen slaan.',
  'CDbLogRoute.connectionID "{id}" does not point to a valid CDbConnection application component.' => 'CDbLogRoute.connectionID "{id}" verwijst niet naar een geldige CDbConnection applicatie component.',
  ...
  'CDirectoryCacheDependency.directory cannot be empty.' => 'CDirectoryCacheDependency.directory kan niet leeg zijn.',
  'CFileCacheDependency.fileName cannot be empty.' => 'CFileCacheDependency.fileName kan niet leeg zijn.',
  ...
  'CFlexWidget.baseUrl cannot be empty.' => 'CFlexWidget.baseUrl kan niet leeg zijn.',
  'CFlexWidget.name cannot be empty.' => 'CFlexWidget.name kan niet leeg zijn.',
  'CGlobalStateCacheDependency.stateName cannot be empty.' => 'CGlobalStateCacheDependency.stateName kan niet leeg zijn.',
  'CHttpCookieCollection can only hold CHttpCookie objects.' => 'CHttpCookieCollection kan alleen CHttpCookie objecten vasthouden.',
  'CHttpRequest is unable to determine the entry script URL.' => 'CHttpRequest is niet in staat om de entry script URL te bepalen.',
  'CHttpRequest is unable to determine the path info of the request.' => 'CHttpRequest is niet in staat om de path informatie van de request te bepalen.',
  'CHttpRequest is unable to determine the request URI.' => 'CHttpRequest is niet in sttat om de request URI te bepalen.',
  'CHttpSession.cookieMode can only be "none", "allow" or "only".' => 'CHttpSession.cookieMode kan alleen "none", "allow" of "only" zijn.',
  'CHttpSession.gcProbability "{value}" is invalid. It must be an integer between 0 and 100.' => 'CHttpSession.gcProbability "{value}" is ongeldig. Het moet een integer waarde zijn tussen 0 and 100.',
  'CHttpSession.savePath "{path}" is not a valid directory.' => 'CHttpSession.savePath "{path}" is een ongeldige directory.',
  'CMemCache requires PHP memcache extension to be loaded.' => 'CMemCache vereist de PHP memcache extensie om te worden geladen',
  'CMemCache server configuration must be an array.' => 'CMemCache server configuratie moet een array zijn.',
  'CMemCache server configuration must have "host" value.' => 'CMemCache server configuratie moet een "host" waarde hebben.',
  ...
  'CSecurityManager.encryptionKey cannot be empty.' => 'CSecurityManager.encryptionKey kan niet leeg zijn.',
  'CSecurityManager.validation must be either "MD5" or "SHA1".' => 'CSecurityManager.validation moet een "MD5" of "SHA1" zijn.',
  'CSecurityManager.validationKey cannot be empty.' => 'CSecurityManager.validationKey kan niet leeg zijn.',
  'CTypedList<{type}> can only hold objects of {type} class.' => 'CTypedList<{type}> kan alleen objecten van type {type} class vasthouden.',
  'CUrlManager.UrlFormat must be either "path" or "get".' => 'CUrlManager.UrlFormat moet een "path" of "get" zijn.',
  'CXCache requires PHP XCache extension to be loaded.' => 'CXCache vereist de PHP XCache extensie om te worden geladen.',
  'Cache table "{tableName}" does not exist.' => 'Cache tabel "{tableName}" bestaat niet.',
  ...
  '{class} must specify "model" and "attribute" or "name" property values.' => '{class} moet "model" en "attribute" of "name" property-waarden specificeren.',
  '{class}.allowAutoLogin must be set true in order to use cookie-based authentication.' => '{class}.allowAutoLogin moet op true worden gezet om de cookie-based authenticatie te kunnen gebruiken',
  '{class}::authenticate() must be implemented.' => '{class}::authenticate() moet worden must be implemented.',
  '{controller} cannot find the requested view "{view}".' => '{controller} kan de gevraagde view niet vinden "{view}".',
