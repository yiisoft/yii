...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute heeft een niet overeenkomstig cod blok "{token}" gevonden. Zorg ervoor dat alle aanroepen naar Yee::beginProfile() en Yee::endProfile() correct genesteld zijn.',
  ...
  'Powered by {yee}.' => 'Aangedreven door {yee}.',
  ...
  'Yes' => 'Ja',
  'Yee application can only be created once.' => 'Er kan slechts 1 Yee applicatie aangemaakt worden.',
