...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute upptäckte ett omatchat kodblock "{token}". Anropen till Yee::beginProfile() och Yee::endProfile() måste vara korrekt nästlade.',
  ...
  'Yee application can only be created once.' => 'Yee applikation kan bara ha en enda instans.',
