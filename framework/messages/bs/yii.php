...
return array (
  ...
  'Active Record requires a "db" CDbConnection application component.' => 'ActiveRecord zahtjeva "db" CDbConnection komponentu aplikacije.',
  ...
  'Active record "{class}" is trying to select an invalid column "{column}". Note, the column must exist in the table or be an expression with alias.' => 'Active record "{class}" klasa pokušava da izabere nevažeću (pogrešnu) kolonu "{column}". Obratite pažnju, kolona mora da postoji u tabeli ili da bude izraz sa alias-om.',
  ...
  'Application base path "{path}" is not a valid directory.' => 'Put do aplikacije (base path) "{path}" nije ispravan direktorijum.',
  'Application runtime path "{path}" is not valid. Please make sure it is a directory writable by the Web server process.' => 'Izvršni put aplikacije (runtime path) "{path}" nije ispravan. Molim vas budite sigurni da je omogućeno upisivanje u direktorijum od strane Web server procesa.',
  'Authorization item "{item}" has already been assigned to user "{user}".' => 'Autorizaciona jedinica "{item}" je već dodjeljena korisniku "{user}".',
  'CApcCache requires PHP apc extension to be loaded.' => 'CApcCache zahtjeva da PHP apc ekstenzija bude učitana.',
  'CAssetManager.basePath "{path}" is invalid. Please make sure the directory exists and is writable by the Web server process.' => 'CAssetManager.basePath "{path}" put nije ispravan. Molim vas budite sigurni da je omogućeno upisivanje u direktorijum od strane Web server procesa.',
  ...
  'CDbAuthManager.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbAuthManager.connectionID "{id}" je pogrešan. Molim vas, budite sigurni da se referencira ID CDbConnection komponente.',
  'CDbCache.connectionID "{id}" is invalid. Please make sure it refers to the ID of a CDbConnection application component.' => 'CDbCache.connectionID "{id}" je pogrešan. Molim vas, budite sigurni da se referencira ID CDbConnection komponente.',
  'CDbCacheDependency.sql cannot be empty.' => 'CDbCacheDependency.sql ne može biti prazan.',
  'CDbCommand failed to execute the SQL statement: {error}' => 'CDbCommand nije uspio da izvrši SQL upit: {error}',
  'CDbCommand failed to prepare the SQL statement: {error}' => 'CDbCommand nije uspio da pripremi SQL upit: {error}',
  ...
  'CDbConnection failed to open the DB connection: {error}' => 'CDbConnection nije uspio da otvori DB konekciju: {error}',
  ...
  'CDbDataReader cannot rewind. It is a forward-only reader.' => 'CDbDataReader ne može da premota (rewind). To je "samo naprijed" (forward-only) čitač.',
  ...
  'CDbLogRoute requires database table "{table}" to store log messages.' => 'CDbLogRoute zahtjeva tabelu "{table}" u bazi podataka za skladištenje poruka logovanja (log messages).',
  ...
  'CDbTransaction is inactive and cannot perform commit or roll back operations.' => 'CDbTransaction nije aktivan i ne može da primjeni commit ili roll back operacije.',
  ...
  'CMemCache requires PHP memcache extension to be loaded.' => 'CMemCache zahtjeva da  PHP memcache ekstenzija bude učitana.',
  ...
  'The requested controller "{controller}" does not exist.' => 'zahtjevani kontroler "{controller}" ne postoji.',
