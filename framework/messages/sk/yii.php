...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute zistil nesprávne usporiadané bloky kódu "{token}". Ubezpečte sa, že volania Yee::beginProfile() a Yee::endProfile() sú vložené správne.',
  ...
  'Yes' => 'Áno',
  'Yee application can only be created once.' => 'Yee aplikácia môže byť vytvorená len jeden raz.',
