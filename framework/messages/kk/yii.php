...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute компоненті қате "{token}" кодын анықтады. Yee::beginProfile() мен Yee::endProfile() шақырулардың ішке салынуы дұрыстығын тексеріңіз.',
  ...
  'Yee application can only be created once.' => 'Yee қолданбасы тек бір рет жасалуы мүмкін.',
