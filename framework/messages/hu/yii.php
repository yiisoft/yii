...
'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'A CProfileLogRoute nem egyező kód-blokkot talált "{token}". Kérjük, győződjön meg róla, hogy a Yee:beginProfile és Yee:endProfile hívásai megfelelően vannak beágyazva.',
...
'Yee application can only be created once.' => 'Yee alkalmazást csak egyszer lehet létrehozni',
