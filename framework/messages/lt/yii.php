...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute rado neteisingą kodo bloką „{token}“. Pasitikslinkite, ar Yee::beginProfile() ir Yee::endProfile() kvietimai teisingai įdėti.',
  ...
  'Yee application can only be created once.' => 'Yee programa gali būti sukurta tik vieną kartą.',
