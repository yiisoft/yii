...
return array (
  ...
  'CProfileLogRoute found a mismatching code block "{token}". Make sure the calls to Yee::beginProfile() and Yee::endProfile() be properly nested.' => 'CProfileLogRoute가 일치하지 않는 코드 블록 "{token}"를 찾았습니다. Yee::beginProfile()와 Yee::endProfile() 호출이 올바르게 중첩되어 있는지 확인하십시오.',
  ...
  'Yee application can only be created once.' => 'Yee 응용 프로그램은 한 번만 만들 수 있습니다.',
