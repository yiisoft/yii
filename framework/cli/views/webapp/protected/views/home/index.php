...
<p>
This is the homepage of <em><?php echo Yii::app()->name; ?></em>. You may modify the following files
...
<dl>
	...
	<dd>This is the layout file that contains common presentation (such as header, footer)
	shared by all view files.</dd>
</dl>
...
<ul>
	...
	<li>If your Web application should be driven by database, do the following:
		<ul>
			<li>Set up database connection by adding a CDbConnection component in the application configuration
...
please read <a href="http://www.yiiframework.com/docs/">Yii documentation</a>
