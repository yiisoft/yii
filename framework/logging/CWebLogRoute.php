...
{
	/**
	 * @var bool whether the log should be displayed in FireBug instead of browser window. Defaults to false.
	 */
	public $showInFireBug=false;
	/**
	 * @var bool whether the log should be ignored in FireBug for ajax calls. Defaults to true.
	...
	/**
	 * @var bool whether the log should be ignored in FireBug for Flash/Flex calls. Defaults to true.
	...
	/**
	 * @var bool whether the log should be collapsed by default in Firebug. Defaults to false.
	 * @since 1.1.13.
	 */
