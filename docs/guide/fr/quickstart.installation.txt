...
L'installation du framework Yii se fait en deux temps :
   ...
   1. Télécharger le framework Yii sur [yiiframework.com](http://www.yiiframework.com/).
...
La condition minimum requise par Yii est d'avoir un serveur Web qui supporte PHP 5.1.0 ou supérieur.
Yii a été testé avec le [serveur HTTP Apache](http://httpd.apache.org/) sur Windows et Linux.
Yii devrait également fonctionner sur les autres serveurs et os supportant PHP 5.

<div class="revision">$Id: quickstart.installation.txt 1906 $</div>
