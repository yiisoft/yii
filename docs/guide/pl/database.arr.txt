...
Dla kluczy złożonych będzie to tablica array('fk_c1'=>'pk_с1','fk_c2'=>'pk_c2').
...
W powyższym przykładzie tablica array('key1'=>'key2')`:
  ...
  - `key1` jest kluczem zdefiniowanym w `throughRelationName`.
  - `key2` jest kluczem zdefiniowanym w `ClassName`.
