...
Модулі можуть бути корисними в декількох ситуаціях. Якщо додаток дуже об'ємний, 
...
Створення модуля
----------------
Модуль організований як директорія, ім'я якої виступає у якості унікального 
...
forum/
   ...
   views/                     містить файли представлень контролера та макетів
      ...
      default/                містить файлы представлень для контролера за замовчуванням
         index.php            файл представлення 'index'
~~~

Модуль повинен мати клас модуля, успадкованого від класу [CWebModule]. І'мя класу визначається
...
щоб звернутися до дії `create` цього контролеру.
