...
Управління URL-адресами у веб-додатках включає в себе два аспекти. По-перше, додатку необхідно розпарсити запит користувача, що надходить у вигляді URL, на легкозрозумілі параметри. По-друге, додаток має надавати спосіб формування адрес URL, з якими воно зможе коректно працювати. У Yii-додатках ці завдання вирішуються з використанням класу [CUrlManager].
