...
class CActiveRecord2Test extends CTestCase
{
	...
	public function testModel()
	{
		...
		$this->assertEquals(array(
			...
			'comments'=>array(CActiveRecord::HAS_MANY,'Comment2','post_id','order'=>'??.content DESC'),
			'categories'=>array(CActiveRecord::MANY_MANY,'Category2','test.post_category(post_id,category_id)','order'=>'??.id DESC')),$model->relations());
