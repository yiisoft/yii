...
class UserWithCustomAttributes extends CActiveRecord
{
	public $publicAttribute;
	protected $_magicAttribute;

	public function setMagicAttribute($magicAttribute)
	{
		$this->_magicAttribute = $magicAttribute;
	}

	public function getMagicAttribute()
	{
		return $this->_magicAttribute;
	}
	...
	{
		$dbTableAttributes = parent::attributeNames();
		$customAttributes = array(
			'publicAttribute',
			'magicAttribute',
		);
		return array_merge($dbTableAttributes, $customAttributes);
	}
