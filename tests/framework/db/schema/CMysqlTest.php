...
class CMysqlTest extends CTestCase
{
	...
	public function testColumn()
	{
		...
		(
			...
			'dbType'=>array('int','varchar(128)','timestamp','int','text'),
		...
		(
			...
			'dbType'=>array('int','int','char(100)','varchar(100)','text','double(4,3)','double','blob','decimal(5,2)','timestamp','tinyint','tinyint','bit','bit(32)'),
