...
"<input type=\"hidden\" value=\"true\" name=\"mySecondParam\" />"),
	...
	public function providerValue()
	{
		...
		// if(version_compare(PHP_VERSION,'8.0','<')) {
			$result=array_merge($result, array(
				array(array('k1' => 'v1', 'k2' => 'v2', 'v3', 'v4'), function($model) {return $model["k2"];}, null, null),
				array((object)array('k1' => 'v1', 'k2' => 'v2', 'v3', 'v4'), function($model) {return $model->k2;}, null, null),
			));
		// }
	...
	public function testAjaxCallbacks()
	{
		...
		$this->assertNotFalse(mb_strpos($out,"'success':function() { /* callback */ }", null, Yii::app()->charset), "Unexpected JavaScript: ".$out);
