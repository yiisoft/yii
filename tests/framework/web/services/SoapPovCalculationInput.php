...
{
	/**
	* @var int Subject type (1 = physical person, 2 = juristic person) {nillable = 0, minOccurs = 1, maxOccurs = 1}
	* @example: 1
	* @soap
	*/
	public $subject;
	...
	/**
	* @var int Usage type <blockquote>1 - Private usage <br/>2 - Taxi<br/>3 - Rental cars</blockquote> {nillable = 0, minOccurs = 1, maxOccurs = 1}
	* @example: 1
	* @soap
	*/
	public $use_kind;
	...
	/**
	* @var int Engine volume 1 < ccm < 3500 ccm.
	* @example: 1397
	* @soap
	*/
	public $ccm_personal;
	...
	/**
	* @var int Engine power kW > 0 {nillable = 1}
	* @example: 55
	* @soap
	*/
	public $car_power;
	...
	/**
	* @var int Vehicle weight 0 < kg < 3500. {minOccurs = 1, maxOccurs = 1}
	* @example: 1615
	* @soap
	*/
	public $car_kg;
	...
	/**
	* @var int Year made. {nillable = false, minOccurs = 1, maxOccurs = 1}
	* @example: 2001
	* @soap
	*/
	...
	*/
	...
	/**
	* @var int Number of previous accidents 0 - 99. {nillable = 0, minOccurs = 1, maxOccurs = 1}
	* @example: 1
	* @soap
	*/
	public $crash;
	...
	/**
	* @var int Payment frequency, 1=annually, 2=half year, 4=quarterly. {nillable = 0, minOccurs = 1, maxOccurs = 1}
	* @example: 2
	* @soap
	*/
	public $payment;
	...
	/**
	* @var int Risk coverage type, 1=lower, 2=higher {nillable = 0, minOccurs = 1, maxOccurs = 1}
	* @example: 1
	* @soap
	*/
