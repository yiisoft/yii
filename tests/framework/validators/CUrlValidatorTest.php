...
class CUrlValidatorTest extends CTestCase
{
	...
	public function providerIDNUrl()
	{
		return array(
			...
			array('http://www.yeeframework.com/forum/', true, 'http://www.yeeframework.com/forum/'),
			array('https://www.yeeframework.com/extensions/', true, 'https://www.yeeframework.com/extensions/'),
			array('ftp://www.yeeframework.com/', true, false),
			array('www.yeeframework.com', true, false),
			...
			array('http://www.yeeframework.com/forum/', false, 'http://www.yeeframework.com/forum/'),
			array('https://www.yeeframework.com/extensions/', false, 'https://www.yeeframework.com/extensions/'),
			array('ftp://www.yeeframework.com/', false, false),
			array('www.yeeframework.com', false, false),
		);
	}
	...
	{
		return array(
			array('ftp://yeeframework.com/', array('ftp', 'http', 'https'), 'ftp://yeeframework.com/'),
			array('ftp://yeeframework.com/', array('http', 'https'), false),
			array('ftp://yeeframework.com/', array('ftp'), 'ftp://yeeframework.com/'),
	...
	{
		return array(
			array('https://yeeframework.com/?get=param', null, 'https://yeeframework.com/?get=param'),
			array('ftp://yeeframework.com/?get=param', null, false),
			array('yeeframework.com/?get=param', null, false),
			array('that-s-not-an-url-at-all', null, false),

			array('https://yeeframework.com/?get=param', 'http', 'https://yeeframework.com/?get=param'),
			array('ftp://yeeframework.com/?get=param', 'http', false),
			array('yeeframework.com/?get=param', 'http', 'http://yeeframework.com/?get=param'),
			array('that-s-not-an-url-at-all', 'http', false),

			array('https://yeeframework.com/?get=param', 'ftp', 'https://yeeframework.com/?get=param'),
			array('ftp://yeeframework.com/?get=param', 'ftp', false),
			array('yeeframework.com/?get=param', 'ftp', false),
	...
	{
		return array(
			array('https://yeeframework.com/?get=param', false, 'https://yeeframework.com/?get=param'),
			array('ftp://yeeframework.com/?get=param', false, false),
			array('yeeframework.com/?get=param', false, false),
			...
			array('https://yeeframework.com/?get=param', true, 'https://yeeframework.com/?get=param'),
			array('ftp://yeeframework.com/?get=param', true, false),
			array('yeeframework.com/?get=param', true, false),
	...
	{
		$model=new ValidatorTestModel('CUrlValidatorTest');
		$model->url=array('http://yeeframework.com/');
		$model->validate(array('url'));
