...
class ScenariosTestModel extends CFormModel
{
	...
	public function rules()
	{
		return array(
			...
			array('firstName', 'required', 'skipOn'=>'scenario3, scenario4'),

			// scenario1, scenario2 and scenario3
			array('lastName', 'required', 'on'=>array('scenario1', 'scenario2', 'scenario3')),

			// scenario1, scenario2 and scenario3
			array('patronymic', 'required', 'skipOn'=>array('scenario4')),

			// scenario1 and scenario3
			array('nickName', 'required', 'on'=>array('scenario1', 'scenario2', 'scenario3'), 'skipOn'=>'scenario2'),
			...
			array('password', 'required', 'on'=>'scenario1,scenario2,scenario3,scenario4',
				'skipOn'=>array('scenario1', 'scenario2', 'scenario3', 'scenario4')),

			// scenario2
			array('birthday', 'required', 'on'=>'scenario2', 'skipOn'=>'scenario3'),
		);
	}
}
